...
<section class="cabin-section">
    ...
    <div class="seat-grid">
        ...
        @foreach(range(21, 40) as $row)
            @if($row == 24) @continue @endif
            @php $rowCols = ($row == 40) ? ['A', 'C', 'H', 'K'] : ['A', 'C', 'D', 'E', 'F', 'G', 'H', 'K']; @endphp
...
<section class="cabin-section">
    ...
    <div class="seat-grid">
        ...
        @foreach(range(41, 58) as $row)
            @php
                if ($row == 41)
                    $rowCols = ['D', 'E', 'F', 'G'];
                elseif ($row >= 54 && $row <= 56)
